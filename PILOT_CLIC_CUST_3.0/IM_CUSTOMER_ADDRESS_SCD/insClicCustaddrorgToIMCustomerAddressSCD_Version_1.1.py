...
FROM
  ...
  FROM
    ...
    lookup_data = (p | 'Read From lookup_query' >> beam.io.Read(beam.io.BigQuerySource(
    ...
    attribute_ref_table = p | 'Read From Attribute Ref Table' >> beam.io.Read(
        beam.io.BigQuerySource(query=Attribute_ref_query, use_standard_sql=True))
