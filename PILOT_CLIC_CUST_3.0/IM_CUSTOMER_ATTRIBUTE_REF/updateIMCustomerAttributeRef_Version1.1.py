...
def run():
    ...
    merged_data = """SELECT
      CAST(d.HSN_ACCT_NUM AS INT64) AS CUSTOMER_ID,
      CAST(d.DELETED_HSN_ACCT_NUM AS INT64) AS MERGED_SOURCE_ACCT_ID,
    ...
    primary_pipeline_4 = 'updated_data_3'
    updated_data_3 = merge_pipelines_dictionary | 'Updating Merged Fields' >> LeftJoin(
    ...
    pipelines_dictionary_SHIPADDR0 = {primary_pipeline_4:updated_data_3,join_pipeline_SHIPADDR0:SHIPADDR0_ADDRS}
    primary_pipeline_SHIPADDR0 = 'SHIPADDR0_data'
    SHIPADDR0_data = (pipelines_dictionary_SHIPADDR0 | 'Left Join 1' >> LeftJoin(
        primary_pipeline_4,updated_data_3,join_pipeline_SHIPADDR0,SHIPADDR0_ADDRS,common_key_2)
                      )

    pipelines_dictionary_BILLADDR1 = {primary_pipeline_SHIPADDR0:SHIPADDR0_data,join_pipeline_BILLADDR1:BILLADDR1_ADDRS}
    primary_pipeline_BILLADDR1 = 'BILLADDR1_data'
    BILLADDR1_data = (pipelines_dictionary_BILLADDR1 | 'Left Join 2' >> LeftJoin(
        primary_pipeline_SHIPADDR0,SHIPADDR0_data,join_pipeline_BILLADDR1,BILLADDR1_ADDRS,common_key_2)
                      )

    pipelines_dictionary_MKTADDR = {primary_pipeline_BILLADDR1:BILLADDR1_data,join_pipeline_MKTADDR:MKTADDR_ADDRS}
    (pipelines_dictionary_MKTADDR | 'Left Join 3' >> LeftJoin(
        primary_pipeline_BILLADDR1,BILLADDR1_data,join_pipeline_MKTADDR,MKTADDR_ADDRS,common_key_2)
